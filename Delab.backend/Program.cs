...
builder.Services.AddDbContext<DataContext>(x=> x.UseSqlServer ("name=DefaultConnection",option => option.MigrationsAssembly ("Delab.backend" )));
...
if (app.Environment.IsDevelopment())
{
    ...
    string swaggerUrl = "https://localhost:7141/swagger"; // URL del Swagger
